...
def start_server(enable_hierarchical_cache:bool = False, enable_kvstore:bool = False, kvstore_compress:bool = False):
    command = f"""
    ...
    {"--hicache-ratio 1.5" if enable_hierarchical_cache else ""} \
...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Enable KVStore for hiradix cache",
    )
    parser.add_argument(
        "--kvstore-compress",
        action="store_true",
...
if __name__ == "__main__":
    ...
    server_process, port = start_server(enable_hierarchical_cache, args.enable_kvstore, args.kvstore_compress)
